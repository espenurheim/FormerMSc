...
import numpy as np
from Cpp_code.former_class_cpp import FormerGame, heuristic_min_groups_1_look_ahead, heuristic_min_groups_2_look_ahead, heuristic_min_groups_3_look_ahead
