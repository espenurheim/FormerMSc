...
def load_ppo_models():
    ...
    critic_large = torch.jit.load("models/reinforcement/scripted_critic.pt", map_location=device)
    critic_large.eval()
    
    actor_small = torch.jit.load("models/reinforcement/scripted_actor_small.pt", map_location=device)
    actor_small.eval()
    
    critic_small = torch.jit.load("models/reinforcement/scripted_critic_small.pt", map_location=device)
    critic_small.eval()
